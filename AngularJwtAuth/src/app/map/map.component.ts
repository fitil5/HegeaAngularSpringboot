...
import am4geodata_spainLow from "@amcharts/amcharts4-geodata/spainProvincesHigh";
...
export class MapComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    chart.hiddenState.properties.opacity = 0; // this makes initial fade in effect
      ...
      chart.geodata = am4geodata_spainLow;//am4geodata_worldLow;
...
function convertirComunidadAOrganizacion(comunidadAutonoma){
...
function generarGrafico(comunidadAutonoma){
  var chart = am4core.create("chartdiv", am4maps.MapChart);
    chart.hiddenState.properties.opacity = 0; // this makes initial fade in effect
...
this.graficosService.createGrafico(convertirComunidadAOrganizacion(comunidadAutonoma))
  .subscribe(grafico => {
    //pieSeries = new am4charts.PieSeries()
    //pieSeries = pieChart.series.push(new am4charts.PieSeries());
    pieSeries.dataFields.value = "y";
